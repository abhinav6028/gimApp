                                ...
                                <Grid container key={index} xs={10} lg={9.5} sx={{ bgcolor: '#ffff', mt: 3 }}>
                                    ...
                                    <Grid container sx={{
                                        ...
                                        <Grid container bgcolor='' lg={2} sx={{
                                            ...
                                            {_data.client?.image != 'string' && _data.client != null ?
                                                <img src={_data.client?.image} alt="fto" width={200} height={200} sx={{
                                                    height: { xs: 80, lg: 120 },
                                                    width: { xs: 80, lg: 120 }
                                                }} />
                                                :
                                        ...
                                        <Grid container bgcolor='' lg={3} sx={{
                                            ...
                                            <Box
                                                component='img'
                                                // src={'Assets/home/Professional.jpeg'}
                                                src={_data?.image ? _data.image : 'Assets/home/Professional.jpeg'}
                                                sx={{
